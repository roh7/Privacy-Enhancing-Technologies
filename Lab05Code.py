...
def credential_Issuing(params, pub, ciphertext, issuer_params):
    ...
    c = to_challenge([g, h, pub, a, b, X1, X1b, new_a, new_b, Cx0,WX1,WX1b,WX1b_2,Wu,Wnew_a,Wnew_b,WCx0])
...
def credential_show_verify_pseudonym(params, issuer_params, pseudonym, tag, proof, service_name):
    ...
    c_prime = to_challenge([g, h, Cx0, X1, u, Cv, Cup, WCv_prime, WV_prime, pseudonym, WN_prime])
